...
<div class="page-wrapper">
    <div class="card">
        <h1 class="title">Edit Tugas</h1>
        <p class="subtitle">Perbarui informasi tugas dan catatan bila diperlukan.</p>
        ...
        <form action="{{ route('tasks.update', $task) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="status-select">
                    <option value="0" {{ old('status', $task->status) ? '' : 'selected' }}>Belum</option>
                    <option value="1" {{ old('status', $task->status) ? 'selected' : '' }}>Selesai</option>
                </select>
            </div>
